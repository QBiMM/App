...
public class TravelAppDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        TravelAppGlobalFeatureConfigurator.Configure();
        TravelAppModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<TravelAppDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<TravelAppResource>("ar")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/TravelApp");

            options.DefaultResourceType = typeof(TravelAppResource);
        ...
        {
            options.MapCodeNamespace("TravelApp", typeof(TravelAppResource));
        });
    }
}
